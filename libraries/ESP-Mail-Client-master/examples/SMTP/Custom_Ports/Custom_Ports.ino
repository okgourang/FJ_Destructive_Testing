...
void setup()
{
    ...
    session.ports_functions.list[1].port = 465;
    session.ports_functions.list[1].protocol = esp_mail_protocol_ssl;

    session.ports_functions.list[2].port = 587;
    session.ports_functions.list[2].protocol = esp_mail_protocol_tls;

    session.ports_functions.list[3].port = 2525;
    session.ports_functions.list[3].protocol = esp_mail_protocol_tls;
